...
class Agent():
    ...
    def __init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions, max_mem_size=15000, eps_end=0.01, eps_dec=5e-4, env,args):
        ...
        # CBF layer
        self.env = env
        self.cbf_layer = CBFQPLayer(env, args, gamma_b, k_d, l_p)
